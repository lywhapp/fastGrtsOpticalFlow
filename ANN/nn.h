...
/* --------------------------------------------------------------------
   Defines
   -------------------------------------------------------------------- */
#define UnknownANN  0x1fffffff
#define FlowType float
...
class Params { public:
  ...
  int do_randomSearch;      /* Do Search. */
  FlowType* SubPixelsFlow;/*�����ؾ��ȵĹ�����ָ��*/
...
BITMAP *init_dist_v2(Params *p, BITMAP *a, BITMAP *b, BITMAP *ann, BITMAP *bmask=NULL, RegionMasks *region_masks=NULL, RegionMasks *amask=NULL);
...
bool getnn(BITMAP *ann, int x, int y, int &xp, int &yp);
...
//================================================================
void VoteNN(IplImage* Results, IplImage* Source,BITMAP *ann, BITMAP *bnn=NULL) ;
